...
#if _MSC_VER <= 1200
typedef unsigned long    	SGD_UINT64;
#else
...
SGD_RV SDIF_KeyAgreement_ECC(SGD_HANDLE hSessionHandle, SGD_UINT32 uiFlag, SGD_UINT32 uiISKIndex, ECCrefPublicKey *pucOwnTmpPublicKey, ECCrefPrivateKey *pucOwnTmpPrivateKey, \
							 ECCrefPublicKey *pucOppositePublicKey, ECCrefPublicKey *pucOppositeTmpPublicKey, SGD_UINT32 uiKeyBits, SGD_UINT32 uiOwnIDLength, SGD_UCHAR *pucOwnID, \
							 SGD_UINT32 uiOppositeIDLength, SGD_UCHAR *pucOppositeID, SGD_UCHAR *pucAgreementData);
